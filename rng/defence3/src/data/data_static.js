...
const BASE_UNIT_STATS = {
    norm: { energy: 40, price: 400, speed: 2.6, atk: 5, attackRange: 0.1, visionRange: 0.8, atkCd: 1.5, astarCost: 10, upKeep: 0.4, color: '#fff', r: 8, vis: 'circle', attackStyle: 'melee' },
    fast: { energy: 20, price: 200, speed: 4.8, atk: 3, attackRange: 0.1, visionRange: 1.0, atkCd: 1.0, astarCost: 10, upKeep: 0.4, color: '#eee', r: 6, vis: 'circle', attackStyle: 'melee' },
    tank: { energy: 80, price: 800, speed: 1.4, atk: 8, attackRange: 0.1, visionRange: 0.6, atkCd: 2.25, astarCost: 10, upKeep: 0.4, color: '#555', r: 10, vis: 'circle', attackStyle: 'melee' },
    boss: { energy: 400, price: 4000, speed: 1.2, atk: 20, attackRange: 0.1, visionRange: 0.8, atkCd: 3.0, astarCost: 10, upKeep: 0.4, color: '#222', r: 12, vis: 'circle', attackStyle: 'melee' },
    flying: { energy: 45, price: 450, speed: 3.0, atk: 4, attackRange: 0.3, visionRange: 1.0, atkCd: 1.75, astarCost: 10, upKeep: 0.4, color: '#dd0', r: 7, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    mole: { energy: 10, price: 100, speed: 1.6, atk: 2, attackRange: 0.1, visionRange: 0.8, atkCd: 1.25, astarCost: 10, upKeep: 0.4, color: '#543', r: 7.5, vis: 'mole', turretImmune: true },
    poison_resistant: { energy: 60, price: 600, speed: 2.4, atk: 6, attackRange: 0.2, visionRange: 0.8, atkCd: 1.75, astarCost: 10, upKeep: 0.4, color: '#2d2', r: 9, vis: 'circle', poisonResistant: true, attackStyle: 'poison' },
    fire_resistant: { energy: 70, price: 700, speed: 2.0, atk: 7, attackRange: 0.2, visionRange: 0.8, atkCd: 2.0, astarCost: 10, upKeep: 0.4, color: '#f50', r: 10, vis: 'circle', fireResistant: true, attackStyle: 'fire' },
    ...
    scout: { energy: 14, price: 140, speed: 5.4, atk: 1, attackRange: 0.1, visionRange: 1.8, atkCd: 1.6, astarCost: 10, upKeep: 0.4, color: '#9cf', r: 5.5, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    ...
    king: { energy: 250, price: 1000, speed: 1.8, atk: 12, attackRange: 0.1, visionRange: 1.0, atkCd: 2.0, astarCost: 10, upKeep: 0.4, color: '#ffd700', r: 12, vis: 'king', attackStyle: 'melee' },
};
