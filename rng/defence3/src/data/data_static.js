...
function buildResourceCollectorCardTypes() {
    ...
    for (let cfg of RESOURCE_TYPE_LIST) {
        out[cfg.farmKey] = { name: cfg.farmName, price: cfg.key === 'astar' ? 50 : 40, icon: cfg.farmIcon, color: cfg.farmColor, visionRange: 0, multiplier: 0.02, upKeep: 0.7, target: 'floor', resourceKey: cfg.key };
        out[cfg.collectorBuildingKey] = { name: cfg.collectorBuildingName, price: cfg.key === 'astar' ? 170 : 150, icon: cfg.collectorBuildingIcon, color: cfg.collectorBuildingColor, visionRange: 0.6, energy: 60, upKeep: 0.7, target: 'floor', resourceKey: cfg.key };
    }
    return out;
}
...
const BASE_CARD_TYPES = {
    ...
    lava: { name: "Lava", price: 50, icon: "\uD83C\uDF0B", color: "#d22", visionRange: 0, burnDps: 1, burnDuration: 1.5, upKeep: 0.6, target: 'floor' },
    poison_puddle: { name: "Poison Puddle", price: 90, icon: "\u2620\uFE0F", color: "#2d2", visionRange: 0, poisonDps: 1, poisonDuration: 1.5, upKeep: 0.5, target: 'floor' },
    ice_patch: { name: "Ice Patch", price: 60, icon: "\u2744\uFE0F", color: "#afe", visionRange: 0, freezeDps: 1, freezeDuration: 1.5, upKeep: 0.7, target: 'floor' },
    water_puddle: { name: "Water Puddle", price: 50, icon: "\uD83D\uDCA7", color: "#4af", visionRange: 0, wetDuration: 3, upKeep: 0.1, target: 'floor' },
    mine: { name: "Mine", price: 20, icon: "\uD83D\uDCA3", color: "#666", visionRange: 0, blastDamage: 135, blastRadius: 0.084, upKeep: 0.1, target: 'floor' },
    ...RESOURCE_COLLECTOR_CARD_TYPES,

    // Special
    salvager: { name: "Salvager", price: 150, icon: "\u267B\uFE0F", color: "#543", visionRange: 0.6, energy: 60, upKeep: 0.25, target: 'floor' },
    builder_spawner: { name: "Builder", price: 180, icon: "\uD83D\uDEA7", color: "#354", visionRange: 0.6, energy: 60, upKeep: 0.25, target: 'floor' },
    healer_spawner: { name: "Healer", price: 180, icon: "\u25B3\u2695\uFE0F", color: "#355", visionRange: 0.6, energy: 60, upKeep: 0.25, target: 'floor' },
    research: { name: "Research", price: 260, icon: "\u25B3\uD83E\uDDEA", color: "#446", visionRange: 0.6, energy: 70, efficiency: 1, upKeep: 0.25, target: 'floor' },
    house: { name: "House", price: 110, icon: "\uD83C\uDFE0", color: "#c95", visionRange: 0.4, energy: 30, upKeep: 0.25, target: 'floor' },
    area_upgrader: { name: "Area Up", price: 100, icon: "\u2B06\uFE0F", color: "#fd0", visionRange: 0.2, upKeep: 0.25, target: 'area_upgrade' },

    // Clouds
    cloud_0a: { name: "Cloud R1", price: 100, icon: "\u2601\uFE0F", color: "#f66", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 0 },
    cloud_0b: { name: "Cloud R2", price: 100, icon: "\u2601\uFE0F", color: "#f66", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 0 },
    cloud_1a: { name: "Cloud B1", price: 100, icon: "\u2601\uFE0F", color: "#66f", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 1 },
    cloud_1b: { name: "Cloud B2", price: 100, icon: "\u2601\uFE0F", color: "#66f", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 1 },
    cloud_2a: { name: "Cloud G1", price: 100, icon: "\u2601\uFE0F", color: "#6f6", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 2 },
    cloud_2b: { name: "Cloud G2", price: 100, icon: "\u2601\uFE0F", color: "#6f6", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 2 },
    cloud_3a: { name: "Cloud Y1", price: 100, icon: "\u2601\uFE0F", color: "#ff6", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 3 },
    cloud_3b: { name: "Cloud Y2", price: 100, icon: "\u2601\uFE0F", color: "#ff6", visionRange: 0, upKeep: 5, target: 'wall', towerEnergy: 200, isCloud: true, pairId: 3 },

    // Barracks (one per unit type)
    barrack_norm: { name: "Barrack", price: 100, icon: "\u26FA", color: "#686", visionRange: 0.8, upKeep: 0.1, target: 'floor', unitType: 'norm' },
    barrack_fast: { name: "Fast Brk", price: 80, icon: "\u26FA", color: "#eee", visionRange: 1.0, upKeep: 0.1, target: 'floor', unitType: 'fast' },
    barrack_tank: { name: "Tank Brk", price: 200, icon: "\u26FA", color: "#555", visionRange: 0.6, upKeep: 0.15, target: 'floor', unitType: 'tank' },
    barrack_boss: { name: "Boss Brk", price: 500, icon: "\u26FA", color: "#222", visionRange: 0.8, upKeep: 0.2, target: 'floor', unitType: 'boss' },
    barrack_flying: { name: "Flying Brk", price: 150, icon: "\u26FA", color: "#dd0", visionRange: 1.0, upKeep: 0.1, target: 'floor', unitType: 'flying' },
    barrack_mole: { name: "Mole Brk", price: 120, icon: "\u26FA", color: "#543", visionRange: 0.8, upKeep: 0.1, target: 'floor', unitType: 'mole' },
    barrack_poison_resistant: { name: "Psn Res Brk", price: 160, icon: "\u26FA", color: "#2d2", visionRange: 0.8, upKeep: 0.28, target: 'floor', unitType: 'poison_resistant' },
    barrack_fire_resistant: { name: "Fire Res Brk", price: 160, icon: "\u26FA", color: "#f50", visionRange: 0.8, upKeep: 0.28, target: 'floor', unitType: 'fire_resistant' },
    barrack_water_resistant: { name: "Wtr Res Brk", price: 160, icon: "\u26FA", color: "#4af", visionRange: 1.0, upKeep: 0.28, target: 'floor', unitType: 'water_resistant' },
    barrack_ice_resistant: { name: "Ice Res Brk", price: 160, icon: "\u26FA", color: "#afe", visionRange: 0.8, upKeep: 0.28, target: 'floor', unitType: 'ice_resistant' },
    barrack_laser_resistant: { name: "Lsr Res Brk", price: 160, icon: "\u26FA", color: "#d0f", visionRange: 0.8, upKeep: 0.28, target: 'floor', unitType: 'laser_resistant' },
    barrack_snake: { name: "Snake Brk", price: 400, icon: "\u26FA", color: "#0f0", visionRange: 0.8, upKeep: 0.32, target: 'floor', unitType: 'snake' },
    barrack_scout: { name: "Scout Brk", price: 90, icon: "\u26FA", color: "#9cf", visionRange: 1.8, upKeep: 0.1, target: 'floor', unitType: 'scout' },
};
...
const BASE_UNIT_STATS = {
    norm: { energy: 40, price: 400, speed: 2.6, atk: 5, attackRange: 0.1, visionRange: 0.8, atkCd: 1.5, astarCost: 10, upKeep: 0.2, color: '#fff', r: 8, vis: 'circle', attackStyle: 'melee' },
    fast: { energy: 20, price: 200, speed: 4.8, atk: 3, attackRange: 0.1, visionRange: 1.0, atkCd: 1.0, astarCost: 10, upKeep: 0.2, color: '#eee', r: 6, vis: 'circle', attackStyle: 'melee' },
    tank: { energy: 80, price: 800, speed: 1.4, atk: 8, attackRange: 0.1, visionRange: 0.6, atkCd: 2.25, astarCost: 10, upKeep: 0.2, color: '#555', r: 10, vis: 'circle', attackStyle: 'melee' },
    boss: { energy: 400, price: 4000, speed: 1.2, atk: 20, attackRange: 0.1, visionRange: 0.8, atkCd: 3.0, astarCost: 10, upKeep: 0.2, color: '#222', r: 12, vis: 'circle', attackStyle: 'melee' },
    flying: { energy: 45, price: 450, speed: 3.0, atk: 4, attackRange: 0.3, visionRange: 1.0, atkCd: 1.75, astarCost: 10, upKeep: 0.2, color: '#dd0', r: 7, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    mole: { energy: 10, price: 100, speed: 1.6, atk: 2, attackRange: 0.1, visionRange: 0.8, atkCd: 1.25, astarCost: 10, upKeep: 0.2, color: '#543', r: 7.5, vis: 'mole', turretImmune: true },
    poison_resistant: { energy: 60, price: 600, speed: 2.4, atk: 6, attackRange: 0.2, visionRange: 0.8, atkCd: 1.75, astarCost: 10, upKeep: 0.2, color: '#2d2', r: 9, vis: 'circle', poisonResistant: true, attackStyle: 'poison' },
    fire_resistant: { energy: 70, price: 700, speed: 2.0, atk: 7, attackRange: 0.2, visionRange: 0.8, atkCd: 2.0, astarCost: 10, upKeep: 0.2, color: '#f50', r: 10, vis: 'circle', fireResistant: true, attackStyle: 'fire' },
    water_resistant: { energy: 50, price: 500, speed: 3.2, atk: 5, attackRange: 0.2, visionRange: 1.0, atkCd: 1.5, astarCost: 10, upKeep: 0.2, color: '#4af', r: 8, vis: 'circle', waterResistant: true, attackStyle: 'water' },
    ice_resistant: { energy: 65, price: 650, speed: 2.2, atk: 6, attackRange: 0.2, visionRange: 0.8, atkCd: 1.75, astarCost: 10, upKeep: 0.2, color: '#afe', r: 9, vis: 'circle', iceResistant: true, attackStyle: 'ice' },
    laser_resistant: { energy: 55, price: 550, speed: 2.3, atk: 5, attackRange: 0.5, visionRange: 0.8, atkCd: 1.75, astarCost: 10, upKeep: 0.2, color: '#d0f', r: 9, vis: 'circle', laserResistant: true, attackStyle: 'laser' },
    snake: { energy: 800, price: 8000, speed: 3.2, atk: 15, attackRange: 0.1, visionRange: 0.8, atkCd: 1.5, astarCost: 10, upKeep: 0.2, color: '#0f0', r: 7, vis: 'snake', isSnake: true, snakeMaxHistory: 20, attackStyle: 'ram' },
    scout: { energy: 14, price: 140, speed: 5.4, atk: 1, attackRange: 0.1, visionRange: 1.8, atkCd: 1.6, astarCost: 10, upKeep: 0.2, color: '#9cf', r: 5.5, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    ...RESOURCE_COLLECTOR_UNIT_STATS,
    salvager_unit: { energy: 20, price: 20, speed: 1.8, atk: 0, attackRange: 0, visionRange: 0.6, atkCd: 49.95, astarCost: 10, upKeep: 0.2, transferCooldown: 2.0, workerSearchDistance: 2.0, color: '#765', r: 6, vis: 'triangle_down', isWorker: true },
    builder_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 0.6, atkCd: 49.95, astarCost: 10, upKeep: 0.2, builderDps: 25, transferCooldown: 2.0, workerSearchDistance: 2.0, color: '#8b5', r: 6, vis: 'rect', isWorker: true },
    healer_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 0.6, atkCd: 49.95, astarCost: 10, upKeep: 0.2, healerDps: 5, transferCooldown: 2.0, workerSearchDistance: 2.0, color: '#fff', r: 6, collisionR: 3, vis: 'triangle', isWorker: true, isFlying: true },
    researcher_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 0.6, atkCd: 49.95, astarCost: 10, upKeep: 0.2, researcherDps: 15, transferCooldown: 2.0, workerSearchDistance: 2.0, color: '#6af', r: 6, collisionR: 3, vis: 'triangle', isWorker: true, isFlying: true },
    king: { energy: 250, price: 1000, speed: 1.8, atk: 12, attackRange: 0.1, visionRange: 1.0, atkCd: 2.0, astarCost: 10, upKeep: 0.2, color: '#ffd700', r: 12, vis: 'king', attackStyle: 'melee' },
};
