...
const BASE_CARD_TYPES = {
    ...
    mine: { name: "Mine", price: 20, icon: "\uD83D\uDCA3", color: "#666", visionRange: 0, blastDamage: 135, blastRadius: 0.42, target: 'floor' },
    ...
    // Special
    spawner: { name: "Collector", price: 150, icon: "\uD83C\uDFED", color: "#432", visionRange: 3, energy: 60, target: 'floor' },
    astar_spawner: { name: "A*", price: 170, icon: "\u2605", color: "#555", visionRange: 3, energy: 60, target: 'floor' },
    salvager: { name: "Salvager", price: 150, icon: "\u267B\uFE0F", color: "#543", visionRange: 3, energy: 60, target: 'floor' },
    builder_spawner: { name: "Builder", price: 180, icon: "\uD83D\uDEA7", color: "#354", visionRange: 3, energy: 60, target: 'floor' },
    healer_spawner: { name: "Healer", price: 180, icon: "\u25B3\u2695\uFE0F", color: "#355", visionRange: 3, energy: 60, target: 'floor' },
    research: { name: "Research", price: 260, icon: "\u25B3\uD83E\uDDEA", color: "#446", visionRange: 3, energy: 70, efficiency: 1, target: 'floor' },
    house: { name: "House", price: 110, icon: "\uD83C\uDFE0", color: "#c95", visionRange: 2, energy: 30, target: 'floor' },
    area_upgrader: { name: "Area Up", price: 100, icon: "\u2B06\uFE0F", color: "#fd0", visionRange: 1, target: 'area_upgrade' },
    ...
    barrack_norm: { name: "Barrack", price: 100, icon: "\u26FA", color: "#686", visionRange: 4, target: 'floor', unitType: 'norm' },
    barrack_fast: { name: "Fast Brk", price: 80, icon: "\u26FA", color: "#eee", visionRange: 5, target: 'floor', unitType: 'fast' },
    barrack_tank: { name: "Tank Brk", price: 200, icon: "\u26FA", color: "#555", visionRange: 3, target: 'floor', unitType: 'tank' },
    barrack_boss: { name: "Boss Brk", price: 500, icon: "\u26FA", color: "#222", visionRange: 4, target: 'floor', unitType: 'boss' },
    barrack_flying: { name: "Flying Brk", price: 150, icon: "\u26FA", color: "#dd0", visionRange: 5, target: 'floor', unitType: 'flying' },
    barrack_mole: { name: "Mole Brk", price: 120, icon: "\u26FA", color: "#543", visionRange: 4, target: 'floor', unitType: 'mole' },
    barrack_poison_resistant: { name: "Psn Res Brk", price: 160, icon: "\u26FA", color: "#2d2", visionRange: 4, target: 'floor', unitType: 'poison_resistant' },
    barrack_fire_resistant: { name: "Fire Res Brk", price: 160, icon: "\u26FA", color: "#f50", visionRange: 4, target: 'floor', unitType: 'fire_resistant' },
    barrack_water_resistant: { name: "Wtr Res Brk", price: 160, icon: "\u26FA", color: "#4af", visionRange: 5, target: 'floor', unitType: 'water_resistant' },
    barrack_ice_resistant: { name: "Ice Res Brk", price: 160, icon: "\u26FA", color: "#afe", visionRange: 4, target: 'floor', unitType: 'ice_resistant' },
    barrack_laser_resistant: { name: "Lsr Res Brk", price: 160, icon: "\u26FA", color: "#d0f", visionRange: 4, target: 'floor', unitType: 'laser_resistant' },
    barrack_snake: { name: "Snake Brk", price: 400, icon: "\u26FA", color: "#0f0", visionRange: 4, target: 'floor', unitType: 'snake' },
    barrack_scout: { name: "Scout Brk", price: 90, icon: "\u26FA", color: "#9cf", visionRange: 9, target: 'floor', unitType: 'scout' },
};
...
const BASE_UNIT_STATS = {
    norm: { energy: 40, price: 400, speed: 2.6, atk: 5, attackRange: 0.5, visionRange: 4, atkCd: 1.5, astarCost: 10, color: '#fff', r: 8, vis: 'circle', attackStyle: 'melee' },
    fast: { energy: 20, price: 200, speed: 4.8, atk: 3, attackRange: 0.5, visionRange: 5, atkCd: 1.0, astarCost: 10, color: '#eee', r: 6, vis: 'circle', attackStyle: 'melee' },
    tank: { energy: 80, price: 800, speed: 1.4, atk: 8, attackRange: 0.5, visionRange: 3, atkCd: 2.25, astarCost: 10, color: '#555', r: 10, vis: 'circle', attackStyle: 'melee' },
    boss: { energy: 400, price: 4000, speed: 1.2, atk: 20, attackRange: 0.5, visionRange: 4, atkCd: 3.0, astarCost: 10, color: '#222', r: 12, vis: 'circle', attackStyle: 'melee' },
    flying: { energy: 45, price: 450, speed: 3.0, atk: 4, attackRange: 1.5, visionRange: 5, atkCd: 1.75, astarCost: 10, color: '#dd0', r: 7, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    mole: { energy: 10, price: 100, speed: 1.6, atk: 2, attackRange: 0.5, visionRange: 4, atkCd: 1.25, astarCost: 10, color: '#543', r: 7.5, vis: 'mole', turretImmune: true },
    poison_resistant: { energy: 60, price: 600, speed: 2.4, atk: 6, attackRange: 1.0, visionRange: 4, atkCd: 1.75, astarCost: 10, color: '#2d2', r: 9, vis: 'circle', poisonResistant: true, attackStyle: 'poison' },
    fire_resistant: { energy: 70, price: 700, speed: 2.0, atk: 7, attackRange: 1.0, visionRange: 4, atkCd: 2.0, astarCost: 10, color: '#f50', r: 10, vis: 'circle', fireResistant: true, attackStyle: 'fire' },
    water_resistant: { energy: 50, price: 500, speed: 3.2, atk: 5, attackRange: 1.0, visionRange: 5, atkCd: 1.5, astarCost: 10, color: '#4af', r: 8, vis: 'circle', waterResistant: true, attackStyle: 'water' },
    ice_resistant: { energy: 65, price: 650, speed: 2.2, atk: 6, attackRange: 1.0, visionRange: 4, atkCd: 1.75, astarCost: 10, color: '#afe', r: 9, vis: 'circle', iceResistant: true, attackStyle: 'ice' },
    laser_resistant: { energy: 55, price: 550, speed: 2.3, atk: 5, attackRange: 2.5, visionRange: 4, atkCd: 1.75, astarCost: 10, color: '#d0f', r: 9, vis: 'circle', laserResistant: true, attackStyle: 'laser' },
    snake: { energy: 800, price: 8000, speed: 3.2, atk: 15, attackRange: 0.5, visionRange: 4, atkCd: 1.5, astarCost: 10, color: '#0f0', r: 7, vis: 'snake', isSnake: true, snakeMaxHistory: 20, attackStyle: 'ram' },
    scout: { energy: 14, price: 140, speed: 5.4, atk: 1, attackRange: 0.5, visionRange: 9, atkCd: 1.6, astarCost: 10, color: '#9cf', r: 5.5, vis: 'triangle', isFlying: true, attackStyle: 'swoop' },
    collector: { energy: 15, price: 15, speed: 2.0, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, gatherPerTrip: 23, transferCooldown: 2.0, workerSearchDistance: 10, color: '#aaa', r: 6, vis: 'star', isWorker: true },
    astar_collector: { energy: 15, price: 15, speed: 2.0, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, gatherPerTrip: 30, transferCooldown: 2.0, workerSearchDistance: 10, color: '#bbb', r: 6, vis: 'star', isWorker: true },
    salvager_unit: { energy: 20, price: 20, speed: 1.8, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, transferCooldown: 2.0, workerSearchDistance: 10, color: '#765', r: 6, vis: 'triangle_down', isWorker: true },
    builder_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, builderDps: 25, transferCooldown: 2.0, workerSearchDistance: 10, color: '#8b5', r: 6, vis: 'rect', isWorker: true },
    healer_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, healerDps: 5, transferCooldown: 2.0, workerSearchDistance: 10, color: '#fff', r: 6, collisionR: 3, vis: 'triangle', isWorker: true, isFlying: true },
    researcher_unit: { energy: 25, price: 18, speed: 1.9, atk: 0, attackRange: 0, visionRange: 3, atkCd: 49.95, astarCost: 10, researcherDps: 15, transferCooldown: 2.0, workerSearchDistance: 10, color: '#6af', r: 6, collisionR: 3, vis: 'triangle', isWorker: true, isFlying: true },
    king: { energy: 250, price: 1000, speed: 1.8, atk: 12, attackRange: 0.5, visionRange: 5, atkCd: 2.0, astarCost: 10, color: '#ffd700', r: 12, vis: 'king', attackStyle: 'melee' },
};
